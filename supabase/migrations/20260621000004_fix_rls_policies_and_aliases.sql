...
DROP POLICY IF EXISTS lcoin_account_select_own ON lcoin_accounts;
CREATE POLICY lcoin_account_select_own ON lcoin_accounts FOR SELECT TO authenticated USING (auth.uid() = user_id);
DROP POLICY IF EXISTS lcoin_account_select_admin ON lcoin_accounts;
...
DROP POLICY IF EXISTS lcoin_account_insert ON lcoin_accounts;
CREATE POLICY lcoin_account_insert ON lcoin_accounts FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS lcoin_account_update ON lcoin_accounts;
...
DROP POLICY IF EXISTS lcoin_transaction_select_own ON lcoin_transactions;
CREATE POLICY lcoin_transaction_select_own ON lcoin_transactions FOR SELECT TO authenticated USING (auth.uid() = user_id);
DROP POLICY IF EXISTS lcoin_transaction_select_admin ON lcoin_transactions;
...
DROP POLICY IF EXISTS lcoin_transaction_insert ON lcoin_transactions;
...
DROP POLICY IF EXISTS lcoin_package_select_all ON lcoin_packages;
CREATE POLICY lcoin_package_select_all ON lcoin_packages FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS lcoin_package_insert ON lcoin_packages;
...
DROP POLICY IF EXISTS lcoin_package_update ON lcoin_packages;
...
DROP POLICY IF EXISTS lcoin_package_delete ON lcoin_packages;
...
DROP POLICY IF EXISTS lcoin_exchange_rate_select_all ON lcoin_exchange_rate;
CREATE POLICY lcoin_exchange_rate_select_all ON lcoin_exchange_rate FOR SELECT TO anon, authenticated USING (true);
DROP POLICY IF EXISTS lcoin_exchange_rate_insert ON lcoin_exchange_rate;
...
DROP POLICY IF EXISTS lcoin_exchange_rate_update ON lcoin_exchange_rate;
...
DROP POLICY IF EXISTS lcoin_exchange_rate_delete ON lcoin_exchange_rate;
...
DROP POLICY IF EXISTS order_audit_select_admin ON order_audit_logs;
...
DROP POLICY IF EXISTS order_audit_insert_admin ON order_audit_logs;
...
DROP POLICY IF EXISTS notification_insert_admin ON notifications;
...
DROP POLICY IF EXISTS registration_select_own ON registrations;
CREATE POLICY registration_select_own ON registrations FOR SELECT TO authenticated USING (auth.uid() = user_id);
DROP POLICY IF EXISTS registration_select_admin ON registrations;
...
DROP POLICY IF EXISTS seat_select_all ON seats;
...
DROP POLICY IF EXISTS admin_profile_select_own ON admin_profiles;
