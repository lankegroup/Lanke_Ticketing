-- Fix: Ensure refund system works
...
-- Recreate calculate_refund_penalty with error handling
...
-- Recreate get_cancel_preview with error handling
...
-- Recreate cancel_ticket with error handling
