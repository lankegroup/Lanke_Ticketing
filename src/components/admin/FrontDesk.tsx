...
export default function FrontDesk() {
  ...
  async function handleSubmit() {
    ...
    const totalPrice = selectedSession.ticket_price + (selectedSession.default_service_fee || 0);
  ...
  const totalPrice = selectedSession ? selectedSession.ticket_price + (selectedSession.default_service_fee || 0) : 0;
        ...
        {step === 'phone' && (
          <div className="max-w-md mx-auto space-y-6">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <p className="text-gray-500 text-center text-sm mb-6">输入客户手机号，系统自动识别是否为会员</p>
          ...
          <div className="max-w-md mx-auto space-y-4">
            ...
            {sessions.length === 0 ? (
              <div className="bg-white rounded-2xl p-8 text-center">
                ...
                <p className="text-sm text-gray-400">暂无可预订场次</p>
              </div>
            ) : (
                    ...
                    >
                      ...
                      <div className="mt-1.5 flex items-center gap-2">
                        ...
                        {s.default_service_fee > 0 && (
                          <span className="text-xs text-gray-400">+{s.default_service_fee} 服务费</span>
                        )}
                      </div>
                    </button>
                  );
          ...
          <div className="max-w-md mx-auto space-y-4">
            ...
            {isForceBooking && (
              <div className="bg-amber-50 border border-amber-300 rounded-xl px-3 py-2.5 flex items-start gap-2">
                ...
                <p className="text-xs text-amber-700 font-medium">强制预订模式：预订屏蔽座位 {selectedSeat?.seat_name}</p>
              </div>
            )}
            ...
            {!customerUser && (
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">仅支持现金支付</p>
                </div>
              </div>
            )}
            ...
            >
              {submitting ? '提交中...' : isForceBooking ? '强制预订确认' : `确认购票（${totalPrice} L-Coin）`}
            </button>
          </div>
        )}
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-500 mb-4">
                {customerUser ? '订单已生成在客户名下' : '散客订单已生成'}
              </p>
              {ticketCode && (
